...
CRONTAB_COMMAND_PREFIX = "DB_ENGINE=" + os.environ['DB_ENGINE'] + " MYSQL_SERVER=" + os.environ[
    'MYSQL_SERVER'] + " MYSQL_PORT=" + os.environ['MYSQL_PORT'] + " MYSQL_DATABASE=" + os.environ[
                             'MYSQL_DATABASE'] + " MYSQL_USERNAME=" + os.environ[
                             'MYSQL_USERNAME'] + " MYSQL_USERPASS=" + os.environ['MYSQL_USERPASS'] + " DJANGO_DEBUG" + \
